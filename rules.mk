...
TARGET_CFLAGS:=$(TARGET_OPTIMIZATION)$(if $(CONFIG_DEBUG), -g3) -Wno-implicit-fallthrough $(call qstrip,$(CONFIG_EXTRA_OPTIMIZATION))
...
HOST_CFLAGS:=-O2 $(HOST_CPPFLAGS) -DHAVE_PTRDIFF_T
