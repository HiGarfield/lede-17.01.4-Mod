...
MIPS_MACHINE(ATH79_MACH_TL_WR841N_V8_CN, "TL-WR841N-v8-CN", "TP-LINK TL-WR841N/ND v8 (CN)",
...
static void __init tl_wr842n_v2_cn_setup(void)
{
	tl_ap123_setup(false);
...
MIPS_MACHINE(ATH79_MACH_TL_WR842N_V2_CN, "TL-WR842N-v2-CN", "TP-LINK TL-WR842N/ND v2 (CN)",
	     tl_wr842n_v2_cn_setup);
