...
function interfaceWarnings() -- display status and warning messages at the top of the page
	...
	if interfaceNumber <= 250 then
		warnings = "<strong>"..string.format(translate("There are currently %d of 250 supported interfaces configured"), interfaceNumber).."</strong>"
	else
		warnings = "<font color=\"ff0000\"><strong>"..string.format(translate("WARNING: %d interfaces are configured exceeding the maximum of 250!"),interfaceNumber).."</strong></font>"
	end
