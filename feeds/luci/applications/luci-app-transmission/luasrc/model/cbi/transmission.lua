...
local webinstalled = luci.model.ipkg.installed("transmission-web") or luci.model.ipkg.installed("transmission-web-control")
local button = ""
...
download_dir.description = "<strong><font color=\"red\">"..translate("Please create the download directory before enabling transmission.").."</font></strong>"
...
incomplete_dir.description = "<strong><font color=\"red\">"..translate("Please create the incomplete directory before enabling transmission.").."</font></strong>"
