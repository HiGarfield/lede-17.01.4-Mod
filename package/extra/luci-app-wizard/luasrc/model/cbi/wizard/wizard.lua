...
local m = Map("wizard", luci.util.pcdata(translate("Inital Router Setup")),
...
if has_wifi then
    s:tab("wifisetup", translate("Wireless Settings"), translate(
        "Set the router's wireless name and password. For more advanced settings, please go to the Network-Wireless page."))
end
...
if has_wifi then
    ...
    e.password = true
    e.cfgvalue = function(self, section)
        return uci:get("wireless", "@wifi-iface[0]", "key")
    end
