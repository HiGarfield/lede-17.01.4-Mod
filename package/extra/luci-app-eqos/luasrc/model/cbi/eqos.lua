...
local m = Map("eqos", translate("Easy QoS"))
...
local dl = s:option(Value, "download", translate("Download speed (Kbit/s)"), translate("Total bandwidth"))
dl.datatype = "and(uinteger,min(1))"

local ul = s:option(Value, "upload", translate("Upload speed (Kbit/s)"), translate("Total bandwidth"))
